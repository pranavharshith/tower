...
class TdMaps {
  ...
  static const List<MapOption> options = [
    ...
    MapOption(key: 'spiral', label: 'Spiral'),
...
class TdMapData {
  ...
  factory TdMapData.fromJson(Map<String, dynamic> json) {
    ...
    List<List<int>> toInt2D(dynamic arr) {
      return (arr as List)
          .map<List<int>>((col) => (col as List).map<int>((v) => toInt(v)).toList(growable: false))
